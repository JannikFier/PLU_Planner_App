...
- **PDF:** Bei „Nach Warengruppen“ bricht das PDF platzsparend: neue Seite nur, wenn die nächste Warengruppe komplett nicht mehr in den unteren Rand passt. Die Layout-Option **„Vorschau: eine Seite pro Warengruppe“** betrifft nur die Vorschau in den Einstellungen, nicht einen harten Umbruch im PDF.
